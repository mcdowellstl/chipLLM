...
0. **Duplicate Case Prevention Protocol (MANDATORY FIRST STEP)**:
   ...
   - **Scan and Match**: You MUST call `get_active_tickets(status_filter="open")` immediately to retrieve active cases. Analyze the user's reported symptom, error code, or affected hardware against the descriptions in the active cases.
